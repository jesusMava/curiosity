...
ActiveRecord::Schema.define(version: 2022_02_01_161320) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["curiosity_card_id"], name: "index_comments_on_curiosity_card_id"
  ...
  create_table "curiosity_cards", force: :cascade do |t|
    ...
    t.index ["category_id"], name: "index_curiosity_cards_on_category_id"
